...
class TbydController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/TbydList", [PermissionMiddleware::class], "list.tbyd")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "TbydList");
    }
}
