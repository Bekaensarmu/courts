...
class ListfileController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ListfileList", [PermissionMiddleware::class], "list.listfile")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListfileList");
    }
}
