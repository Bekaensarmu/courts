...
class EsregnaController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/EsregnaList", [PermissionMiddleware::class], "list.esregna")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "EsregnaList");
    }
}
