...
/**
 * Crosstab2 controller
 */
class Crosstab2Controller extends ControllerBase
{
    // crosstab
    #[Map(["GET", "POST", "OPTIONS"], "/Crosstab2", [PermissionMiddleware::class], "crosstab.Crosstab2")]
    public function crosstab(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Crosstab2Crosstab");
    }
}
