...
/**
 * Table class for tekesash
 */
class Tekesash extends CrosstabTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'esregna'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->mid->SourceTableVar = 'esregna';
        ...
        $this->rank->SourceTableVar = 'esregna';
        ...
        $this->name->SourceTableVar = 'esregna';
        ...
        $this->deptName->SourceTableVar = 'esregna';
        $this->Fields['deptName'] = &$this->deptName;

        // ChargeDate
        $this->ChargeDate = new ReportField(
            $this, // Table
        ...
        $this->ChargeDate->SourceTableVar = 'esregna';
        ...
        $this->created_at->UseFilter = true; // Table header filter
        $this->created_at->Lookup = new Lookup($this->created_at, 'tekesash', true, 'created_at', ["created_at","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->created_at->LookupExpression = "YEAR(`created_at`)";
        $this->created_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->created_at->SearchOperators = ["="];
        $this->created_at->SourceTableVar = 'esregna';
        $this->created_at->SearchType = "dropdown";
    ...
    {
        return ($this->sqlCrosstabYear != "") ? $this->sqlCrosstabYear : "SELECT DISTINCT YEAR(`created_at`) AS YEAR__created_at FROM esregna ORDER BY YEAR(`created_at`)";
    }
    ...
    {
        return "`rank`, YEAR(`created_at`) AS YEAR__created_at";
    }
    ...
    {
        return $this->SqlGroupBy != "" ? $this->SqlGroupBy : "`rank`, YEAR(`created_at`)";
    }
