...
class AppointmentsEdit extends Appointments
{
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'case_hear_id' first before field var 'x_case_hear_id'
        $val = $CurrentForm->hasValue("case_hear_id") ? $CurrentForm->getValue("case_hear_id") : $CurrentForm->getValue("x_case_hear_id");
        if (!$this->case_hear_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->case_hear_id->Visible = false; // Disable update for API request
            } else {
                $this->case_hear_id->setFormValue($val, true, $validate);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->case_hear_id->CurrentValue = $this->case_hear_id->FormValue;
    ...
    public function renderRow()
    {
        ...
        // case_hear_id
        $this->case_hear_id->RowCssClass = "row";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // case_hear_id
            $this->case_hear_id->setupEditAttributes();
            $this->case_hear_id->EditValue = $this->case_hear_id->CurrentValue;
            $this->case_hear_id->PlaceHolder = RemoveHtml($this->case_hear_id->caption());
            if (strval($this->case_hear_id->EditValue) != "" && is_numeric($this->case_hear_id->EditValue)) {
                $this->case_hear_id->EditValue = FormatNumber($this->case_hear_id->EditValue, null);
            }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->case_hear_id->Visible && $this->case_hear_id->Required) {
                if (!$this->case_hear_id->IsDetailKey && EmptyValue($this->case_hear_id->FormValue)) {
                    $this->case_hear_id->addErrorMessage(str_replace("%s", $this->case_hear_id->caption(), $this->case_hear_id->RequiredErrorMessage));
                }
            }
            if (!CheckInteger($this->case_hear_id->FormValue)) {
                $this->case_hear_id->addErrorMessage($this->case_hear_id->getErrorMessage(false));
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // case_hear_id
        $this->case_hear_id->setDbValueDef($rsnew, $this->case_hear_id->CurrentValue, $this->case_hear_id->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['case_hear_id'])) { // case_hear_id
            $this->case_hear_id->CurrentValue = $row['case_hear_id'];
        }
