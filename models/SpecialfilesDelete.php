 ...
 * Page class
 */
class SpecialfilesDelete extends Specialfiles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SpecialfilesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "SpecialfilesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SpecialfilesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("SpecialfilesList"); // Return to list
                return;
            }
        }
