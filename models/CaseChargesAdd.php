 ...
 * Page class
 */
class CaseChargesAdd extends CaseCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CaseChargesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "CaseChargesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CaseChargesView") {
    ...
    protected function getAddRow()
    {
        ...
        // crimeDescription
        $this->crimeDescription->setDbValueDef($rsnew, $this->crimeDescription->CurrentValue, false);

        // crimeDate
        $this->crimeDate->setDbValueDef($rsnew, UnFormatDateTime($this->crimeDate->CurrentValue, $this->crimeDate->formatPattern()), false);

        // ChargeDate
        $this->ChargeDate->setDbValueDef($rsnew, UnFormatDateTime($this->ChargeDate->CurrentValue, $this->ChargeDate->formatPattern()), false);
