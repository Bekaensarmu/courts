 ...
 */
class Report5 extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->decisionDate->GroupingFieldId = 1;
        $this->decisionDate->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->decisionDate->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->decisionDate->GroupByType = "";
        $this->decisionDate->GroupInterval = "0";
        $this->decisionDate->GroupSql = "";
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->decisionDate;
    ...
    {
        $this->decisionDate->ViewValue = FormatDateTime($this->decisionDate->CurrentValue, $this->decisionDate->formatPattern());
    }
