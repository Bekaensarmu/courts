...
class UsersAdd extends Users
{
    ...
    protected function getAddRow()
    {
        ...
        // current_team_id
        if ($Security->canAdmin()) { // System admin
            $this->current_team_id->setDbValueDef($rsnew, $this->current_team_id->CurrentValue, false);
        }

        // profile_photo_path
        $this->profile_photo_path->setDbValueDef($rsnew, $this->profile_photo_path->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['current_team_id'])) { // current_team_id
            $this->current_team_id->setFormValue($row['current_team_id']);
        }
        if (isset($row['profile_photo_path'])) { // profile_photo_path
            $this->profile_photo_path->setFormValue($row['profile_photo_path']);
        }
