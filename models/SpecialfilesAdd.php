 ...
 * Page class
 */
class SpecialfilesAdd extends Specialfiles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SpecialfilesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "SpecialfilesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SpecialfilesView") {
    ...
    protected function getAddRow()
    {
        ...
        // ዕዝ
        $this->_12D512DD->setDbValueDef($rsnew, $this->_12D512DD->CurrentValue, false);

        // የችሎትስም
        $this->_12E8127D120E12751235121D->setDbValueDef($rsnew, $this->_12E8127D120E12751235121D->CurrentValue, false);

        // የክርክሩሂደት
        $this->_12E812AD122D12AD1229120212F01275->setDbValueDef($rsnew, $this->_12E812AD122D12AD1229120212F01275->CurrentValue, false);

        // የክስዓይነት
        $this->_12E812AD123512D312ED12901275->setDbValueDef($rsnew, $this->_12E812AD123512D312ED12901275->CurrentValue, false);

        // የቀጠሮምክንያት
        $this->_12E812401320122E121D12AD129512EB1275->setDbValueDef($rsnew, $this->_12E812401320122E121D12AD129512EB1275->CurrentValue, false);

        // የውሳኔዓይነት
        $this->_12E812CD1233129412D312ED12901275->setDbValueDef($rsnew, $this->_12E812CD1233129412D312ED12901275->CurrentValue, false);

        // ማዕረግ
        $this->_121B12D51228130D->setDbValueDef($rsnew, $this->_121B12D51228130D->CurrentValue, false);

        // ማብራርያ
        $this->_121B1265122B122D12EB->setDbValueDef($rsnew, $this->_121B1265122B122D12EB->CurrentValue, false);

        // የተመዘገበበትቀን
        $this->_12E81270121812D8130812601260127512401295->setDbValueDef($rsnew, UnFormatDateTime($this->_12E81270121812D8130812601260127512401295->CurrentValue, $this->_12E81270121812D8130812601260127512401295->formatPattern()), false);
        return $rsnew;
    }
    ...
    {
        if (isset($row['ዕዝ'])) { // ዕዝ
            $this->_12D512DD->setFormValue($row['ዕዝ']);
        }
        if (isset($row['የችሎትስም'])) { // የችሎትስም
            $this->_12E8127D120E12751235121D->setFormValue($row['የችሎትስም']);
        }
        if (isset($row['የክርክሩሂደት'])) { // የክርክሩሂደት
            $this->_12E812AD122D12AD1229120212F01275->setFormValue($row['የክርክሩሂደት']);
        }
        if (isset($row['የክስዓይነት'])) { // የክስዓይነት
            $this->_12E812AD123512D312ED12901275->setFormValue($row['የክስዓይነት']);
        }
        if (isset($row['የቀጠሮምክንያት'])) { // የቀጠሮምክንያት
            $this->_12E812401320122E121D12AD129512EB1275->setFormValue($row['የቀጠሮምክንያት']);
        }
        if (isset($row['የውሳኔዓይነት'])) { // የውሳኔዓይነት
            $this->_12E812CD1233129412D312ED12901275->setFormValue($row['የውሳኔዓይነት']);
        }
        if (isset($row['ማዕረግ'])) { // ማዕረግ
            $this->_121B12D51228130D->setFormValue($row['ማዕረግ']);
        }
        if (isset($row['ማብራርያ'])) { // ማብራርያ
            $this->_121B1265122B122D12EB->setFormValue($row['ማብራርያ']);
        }
        if (isset($row['የተመዘገበበትቀን'])) { // የተመዘገበበትቀን
            $this->_12E81270121812D8130812601260127512401295->setFormValue($row['የተመዘገበበትቀን']);
        }
    }
