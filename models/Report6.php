 ...
 */
class Report6 extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'attorneys'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id->SourceTableVar = 'attorneys';
        $this->Fields['id'] = &$this->id;

        // attorneyID
        $this->attorneyID = new ReportField(
            $this, // Table
        ...
        $this->attorneyID->SourceTableVar = 'attorneys';
        ...
        $this->Name->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->Name->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->Name->GroupByType = "";
        $this->Name->GroupInterval = "0";
        $this->Name->GroupSql = "";
        ...
        $this->Name->SourceTableVar = 'attorneys';
        ...
        $this->phone->SourceTableVar = 'attorneys';
        ...
        $this->Address->SourceTableVar = 'attorneys';
        $this->Fields['Address'] = &$this->Address;

        // State
        $this->State = new ReportField(
            $this, // Table
        ...
        $this->State->SourceTableVar = 'attorneys';
        $this->Fields['State'] = &$this->State;

        // EmpType
        $this->EmpType = new ReportField(
            $this, // Table
        ...
        $this->EmpType->Lookup = new Lookup($this->EmpType, 'Report6', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->EmpType->OptionCount = 2;
        $this->EmpType->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->EmpType->SourceTableVar = 'attorneys';
        ...
        $this->description->SourceTableVar = 'attorneys';
        ...
        $this->created_at->SourceTableVar = 'attorneys';
        ...
        $this->updated_at->SourceTableVar = 'attorneys';
        ...
        $this->updated_by->SourceTableVar = 'attorneys';
