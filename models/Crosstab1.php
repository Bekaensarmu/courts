...
class Crosstab1 extends CrosstabTable
{
    ...
    public function __construct()
    {
        ...
        $this->sex->Lookup = new Lookup($this->sex, 'Crosstab1', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->created_at->LookupExpression = "YEAR(`created_at`)";
        ...
        // YEAR__created_at
        $this->YEAR__created_at = new ReportField($this, 'x_YEAR__created_at', 'YEAR__created_at', 'YEAR(`created_at`)', '', 3, -1, -1, false, '', false, false, false);
        $this->YEAR__created_at->Sortable = false;
        $this->YEAR__created_at->Caption = $Language->phrase("Year");
        $this->Fields['YEAR__created_at'] = &$this->YEAR__created_at;
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("YEAR(`created_at`) AS YEAR__created_at");
    }
    ...
    {
        return ($this->sqlGroupByAggregate != "") ? $this->sqlGroupByAggregate : "YEAR(`created_at`)";
    }
    ...
    {
        return ($this->columnField != "") ? $this->columnField : "`created_at`";
    }
    ...
    {
        return ($this->sqlCrosstabYear != "") ? $this->sqlCrosstabYear : "SELECT DISTINCT YEAR(`created_at`) AS YEAR__created_at FROM case_hears ORDER BY YEAR(`created_at`)";
    }
    ...
    {
        return "`RANKe`, YEAR(`created_at`) AS YEAR__created_at";
    }
    ...
    {
        return $this->SqlGroupBy != "" ? $this->SqlGroupBy : "`RANKe`, YEAR(`created_at`)";
    }
