 ...
 * Page class
 */
class AttorneysAdd extends Attorneys
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AttorneysAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AttorneysAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AttorneysView") {
    ...
    protected function getAddRow()
    {
        ...
        // attorneyID
        $this->attorneyID->setDbValueDef($rsnew, $this->attorneyID->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['attorneyID'])) { // attorneyID
            $this->attorneyID->setFormValue($row['attorneyID']);
        }
