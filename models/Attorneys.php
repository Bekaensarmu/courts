...
/**
 * Table class for attorneys
 */
class Attorneys extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // attorneyID
        $this->attorneyID = new DbField(
            $this, // Table
            'x_attorneyID', // Variable name
            'attorneyID', // Name
            '`attorneyID`', // Expression
            '`attorneyID`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`attorneyID`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->attorneyID->InputTextType = "text";
        $this->attorneyID->Nullable = false; // NOT NULL field
        $this->attorneyID->Required = true; // Required field
        $this->attorneyID->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['attorneyID'] = &$this->attorneyID;
        ...
        $this->EmpType->Lookup = new Lookup($this->EmpType, 'attorneys', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->EmpType->OptionCount = 2;
        $this->EmpType->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "attorneys";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->attorneyID->DbValue = $row['attorneyID'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AttorneysList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "AttorneysView" => $Language->phrase("View"),
            "AttorneysEdit" => $Language->phrase("Edit"),
            "AttorneysAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "AttorneysView",
            Config("API_ADD_ACTION") => "AttorneysAdd",
            Config("API_EDIT_ACTION") => "AttorneysEdit",
            Config("API_DELETE_ACTION") => "AttorneysDelete",
            Config("API_LIST_ACTION") => "AttorneysList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AttorneysView", $parm);
        } else {
            $url = $this->keyUrl("AttorneysView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AttorneysEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AttorneysList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AttorneysAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AttorneysList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AttorneysDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->attorneyID->EditValue = $this->attorneyID->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->attorneyID);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->attorneyID);
