 ...
 */
class Report4 extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->keterodate->GroupingFieldId = 1;
        $this->keterodate->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->keterodate->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->keterodate->GroupByType = "";
        $this->keterodate->GroupInterval = "0";
        $this->keterodate->GroupSql = "";
        ...
        $this->sex->Lookup = new Lookup($this->sex, 'Report4', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->keterodate;
    ...
    {
        $this->keterodate->ViewValue = FormatDateTime($this->keterodate->CurrentValue, $this->keterodate->formatPattern());
    }
