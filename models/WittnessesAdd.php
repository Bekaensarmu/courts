 ...
 * Page class
 */
class WittnessesAdd extends Wittnesses
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WittnessesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "WittnessesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "WittnessesView") {
    ...
    protected function getAddRow()
    {
        ...
        // wittnessType
        $this->wittnessType->setDbValueDef($rsnew, $this->wittnessType->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['wittnessType'])) { // wittnessType
            $this->wittnessType->setFormValue($row['wittnessType']);
        }
