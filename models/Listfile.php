...
/**
 * Table class for listfile
 */
class Listfile extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->yekisaynet->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->chilotname->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->ez->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->keteroreason->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->kirihidet->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "listfile";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ListfileList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ListfileView" => $Language->phrase("View"),
            "ListfileEdit" => $Language->phrase("Edit"),
            "ListfileAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ListfileView",
            Config("API_ADD_ACTION") => "ListfileAdd",
            Config("API_EDIT_ACTION") => "ListfileEdit",
            Config("API_DELETE_ACTION") => "ListfileDelete",
            Config("API_LIST_ACTION") => "ListfileList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ListfileView", $parm);
        } else {
            $url = $this->keyUrl("ListfileView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ListfileEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ListfileList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ListfileAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ListfileList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ListfileDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->yekisaynet->Raw) {
            $this->yekisaynet->CurrentValue = HtmlDecode($this->yekisaynet->CurrentValue);
        }
        $this->yekisaynet->EditValue = $this->yekisaynet->CurrentValue;
        $this->yekisaynet->PlaceHolder = RemoveHtml($this->yekisaynet->caption());

        // chilotname
        $this->chilotname->setupEditAttributes();
        if (!$this->chilotname->Raw) {
            $this->chilotname->CurrentValue = HtmlDecode($this->chilotname->CurrentValue);
        }
        $this->chilotname->EditValue = $this->chilotname->CurrentValue;
        $this->chilotname->PlaceHolder = RemoveHtml($this->chilotname->caption());

        // ez
        $this->ez->setupEditAttributes();
        if (!$this->ez->Raw) {
            $this->ez->CurrentValue = HtmlDecode($this->ez->CurrentValue);
        }
        $this->ez->EditValue = $this->ez->CurrentValue;
        $this->ez->PlaceHolder = RemoveHtml($this->ez->caption());

        // keteroreason
        $this->keteroreason->setupEditAttributes();
        if (!$this->keteroreason->Raw) {
            $this->keteroreason->CurrentValue = HtmlDecode($this->keteroreason->CurrentValue);
        }
        $this->keteroreason->EditValue = $this->keteroreason->CurrentValue;
        ...
        if (!$this->kirihidet->Raw) {
            $this->kirihidet->CurrentValue = HtmlDecode($this->kirihidet->CurrentValue);
        }
        $this->kirihidet->EditValue = $this->kirihidet->CurrentValue;
