...
/**
 * Table class for tbyd
 */
class Tbyd extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tbyd";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TbydList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TbydView" => $Language->phrase("View"),
            "TbydEdit" => $Language->phrase("Edit"),
            "TbydAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TbydView",
            Config("API_ADD_ACTION") => "TbydAdd",
            Config("API_EDIT_ACTION") => "TbydEdit",
            Config("API_DELETE_ACTION") => "TbydDelete",
            Config("API_LIST_ACTION") => "TbydList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TbydView", $parm);
        } else {
            $url = $this->keyUrl("TbydView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TbydList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TbydList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TbydDelete", $parm);
        }
    }
