...
/**
 * Table class for case_charges
 */
class CaseCharges extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->deptName->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['deptName'] = &$this->deptName;

        // mid
        $this->mid = new DbField(
            $this, // Table
            'x_mid', // Variable name
            'mid', // Name
            '`mid`', // Expression
        ...
        $this->mid->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['mid'] = &$this->mid;

        // rank
        $this->rank = new DbField(
            $this, // Table
        ...
        $this->rank->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        // crimeDescription
        $this->crimeDescription = new DbField(
            $this, // Table
            'x_crimeDescription', // Variable name
            'crimeDescription', // Name
            '`crimeDescription`', // Expression
            '`crimeDescription`', // Basic search expression
            200, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`crimeDescription`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->crimeDescription->InputTextType = "text";
        $this->crimeDescription->Nullable = false; // NOT NULL field
        $this->crimeDescription->Required = true; // Required field
        $this->crimeDescription->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['crimeDescription'] = &$this->crimeDescription;

        // crimeDate
        $this->crimeDate = new DbField(
            $this, // Table
        ...
        // ChargeDate
        $this->ChargeDate = new DbField(
            $this, // Table
            'x_ChargeDate', // Variable name
            'ChargeDate', // Name
            '`ChargeDate`', // Expression
            CastDateFieldForLike("`ChargeDate`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
            '`ChargeDate`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->ChargeDate->InputTextType = "text";
        $this->ChargeDate->Raw = true;
        $this->ChargeDate->Nullable = false; // NOT NULL field
        $this->ChargeDate->Required = true; // Required field
        $this->ChargeDate->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->ChargeDate->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['ChargeDate'] = &$this->ChargeDate;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "case_charges";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->mid->DbValue = $row['mid'];
        $this->rank->DbValue = $row['rank'];
        $this->name->DbValue = $row['name'];
        $this->address->DbValue = $row['address'];
        $this->state->DbValue = $row['state'];
        $this->crimeDescription->DbValue = $row['crimeDescription'];
        $this->crimeDate->DbValue = $row['crimeDate'];
        $this->ChargeDate->DbValue = $row['ChargeDate'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CaseChargesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "CaseChargesView" => $Language->phrase("View"),
            "CaseChargesEdit" => $Language->phrase("Edit"),
            "CaseChargesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CaseChargesView",
            Config("API_ADD_ACTION") => "CaseChargesAdd",
            Config("API_EDIT_ACTION") => "CaseChargesEdit",
            Config("API_DELETE_ACTION") => "CaseChargesDelete",
            Config("API_LIST_ACTION") => "CaseChargesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CaseChargesView", $parm);
        } else {
            $url = $this->keyUrl("CaseChargesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CaseChargesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CaseChargesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CaseChargesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CaseChargesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("CaseChargesDelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        // crimeDescription
        $this->crimeDescription->ViewValue = $this->crimeDescription->CurrentValue;
        ...
        // crimeDescription
        $this->crimeDescription->HrefValue = "";
        $this->crimeDescription->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->deptName->Raw) {
            $this->deptName->CurrentValue = HtmlDecode($this->deptName->CurrentValue);
        }
        $this->deptName->EditValue = $this->deptName->CurrentValue;
        $this->deptName->PlaceHolder = RemoveHtml($this->deptName->caption());

        // mid
        $this->mid->setupEditAttributes();
        if (!$this->mid->Raw) {
            $this->mid->CurrentValue = HtmlDecode($this->mid->CurrentValue);
        }
        $this->mid->EditValue = $this->mid->CurrentValue;
        $this->mid->PlaceHolder = RemoveHtml($this->mid->caption());

        // rank
        $this->rank->setupEditAttributes();
        if (!$this->rank->Raw) {
            $this->rank->CurrentValue = HtmlDecode($this->rank->CurrentValue);
        }
        ...
        // crimeDescription
        $this->crimeDescription->setupEditAttributes();
        $this->crimeDescription->EditValue = $this->crimeDescription->CurrentValue;
        $this->crimeDescription->PlaceHolder = RemoveHtml($this->crimeDescription->caption());

        // crimeDate
        $this->crimeDate->setupEditAttributes();
        $this->crimeDate->EditValue = FormatDateTime($this->crimeDate->CurrentValue, $this->crimeDate->formatPattern());
        $this->crimeDate->PlaceHolder = RemoveHtml($this->crimeDate->caption());

        // ChargeDate
        $this->ChargeDate->setupEditAttributes();
        $this->ChargeDate->EditValue = FormatDateTime($this->ChargeDate->CurrentValue, $this->ChargeDate->formatPattern());
        $this->ChargeDate->PlaceHolder = RemoveHtml($this->ChargeDate->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->crimeDescription);
                    $doc->exportCaption($this->crimeDate);
                    $doc->exportCaption($this->ChargeDate);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->crimeDescription);
                        $doc->exportField($this->crimeDate);
                        $doc->exportField($this->ChargeDate);
