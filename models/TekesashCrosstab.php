 ...
 * Page class
 */
class TekesashCrosstab extends Tekesash
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TekesashCrosstab";
    ...
    public $CurrentPageName = "Tekesash";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'tekesash';
        $this->TableName = 'tekesash';
        ...
        // Table object (tekesash)
        if (!isset($GLOBALS["tekesash"]) || $GLOBALS["tekesash"]::class == PROJECT_NAMESPACE . "tekesash") {
            $GLOBALS["tekesash"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'tekesash');
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) {
            // created_at
            if ($this->created_at->UseFilter && !EmptyValue($this->created_at->AdvancedSearch->SearchValue)) {
                if (is_array($this->created_at->AdvancedSearch->SearchValue)) {
                    $this->created_at->AdvancedSearch->SearchValue = implode(Config("FILTER_OPTION_SEPARATOR"), $this->created_at->AdvancedSearch->SearchValue);
                }
                $this->created_at->EditValue = explode(Config("FILTER_OPTION_SEPARATOR"), $this->created_at->AdvancedSearch->SearchValue);
            }
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ftekesashsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftekesashsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftekesashsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    protected function getExtendedFilter()
    {
        ...
        if (Get("cmd") == "reset") {
            ...
            // Field created_at
            $this->getDropDownValue($this->created_at);
        ...
        $this->buildDropDownFilter($this->created_at, $filter, false, true); // Field created_at
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("ftekesashsrch");
        }
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("ftekesashsrch", $filters);
