 ...
 * Page class
 */
class DecisionsDelete extends Decisions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DecisionsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DecisionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DecisionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DecisionsList"); // Return to list
                return;
            }
        }
