 ...
 * Page class
 */
class CaseHearsList extends CaseHears
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CaseHearsList";
    ...
    public $FormName = "fcase_hearslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "CaseHearsList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "CaseHearsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "CaseHearsDelete";
        $this->MultiUpdateUrl = "CaseHearsUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fcase_hearssrch");
        }
        $filterList = Concat($filterList, $this->melequtir->AdvancedSearch->toJson(), ","); // Field melequtir
        $filterList = Concat($filterList, $this->RANKe->AdvancedSearch->toJson(), ","); // Field RANKe
        ...
        $filterList = Concat($filterList, $this->firdbet->AdvancedSearch->toJson(), ","); // Field firdbet
        ...
        $filterList = Concat($filterList, $this->tekesashbizat->AdvancedSearch->toJson(), ","); // Field tekesashbizat
        $filterList = Concat($filterList, $this->keterodate->AdvancedSearch->toJson(), ","); // Field keterodate
        $filterList = Concat($filterList, $this->keterodescription->AdvancedSearch->toJson(), ","); // Field keterodescription
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fcase_hearssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field RANKe
        $this->RANKe->AdvancedSearch->SearchValue = @$filter["x_RANKe"];
        $this->RANKe->AdvancedSearch->SearchOperator = @$filter["z_RANKe"];
        $this->RANKe->AdvancedSearch->SearchCondition = @$filter["v_RANKe"];
        $this->RANKe->AdvancedSearch->SearchValue2 = @$filter["y_RANKe"];
        $this->RANKe->AdvancedSearch->SearchOperator2 = @$filter["w_RANKe"];
        $this->RANKe->AdvancedSearch->save();
        ...
        // Field firdbet
        $this->firdbet->AdvancedSearch->SearchValue = @$filter["x_firdbet"];
        $this->firdbet->AdvancedSearch->SearchOperator = @$filter["z_firdbet"];
        $this->firdbet->AdvancedSearch->SearchCondition = @$filter["v_firdbet"];
        $this->firdbet->AdvancedSearch->SearchValue2 = @$filter["y_firdbet"];
        $this->firdbet->AdvancedSearch->SearchOperator2 = @$filter["w_firdbet"];
        $this->firdbet->AdvancedSearch->save();
        ...
        // Field tekesashbizat
        $this->tekesashbizat->AdvancedSearch->SearchValue = @$filter["x_tekesashbizat"];
        $this->tekesashbizat->AdvancedSearch->SearchOperator = @$filter["z_tekesashbizat"];
        $this->tekesashbizat->AdvancedSearch->SearchCondition = @$filter["v_tekesashbizat"];
        $this->tekesashbizat->AdvancedSearch->SearchValue2 = @$filter["y_tekesashbizat"];
        $this->tekesashbizat->AdvancedSearch->SearchOperator2 = @$filter["w_tekesashbizat"];
        $this->tekesashbizat->AdvancedSearch->save();

        // Field keterodate
        $this->keterodate->AdvancedSearch->SearchValue = @$filter["x_keterodate"];
        $this->keterodate->AdvancedSearch->SearchOperator = @$filter["z_keterodate"];
        $this->keterodate->AdvancedSearch->SearchCondition = @$filter["v_keterodate"];
        $this->keterodate->AdvancedSearch->SearchValue2 = @$filter["y_keterodate"];
        $this->keterodate->AdvancedSearch->SearchOperator2 = @$filter["w_keterodate"];
        $this->keterodate->AdvancedSearch->save();

        // Field keterodescription
        $this->keterodescription->AdvancedSearch->SearchValue = @$filter["x_keterodescription"];
        $this->keterodescription->AdvancedSearch->SearchOperator = @$filter["z_keterodescription"];
        $this->keterodescription->AdvancedSearch->SearchCondition = @$filter["v_keterodescription"];
        $this->keterodescription->AdvancedSearch->SearchValue2 = @$filter["y_keterodescription"];
        $this->keterodescription->AdvancedSearch->SearchOperator2 = @$filter["w_keterodescription"];
        $this->keterodescription->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->sex;
        $searchFlds[] = &$this->keterodescription;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->firdbet); // firdbet
            ...
            $this->updateSort($this->tekesashbizat); // tekesashbizat
            $this->updateSort($this->keterodate); // keterodate
            $this->updateSort($this->keterodescription); // keterodescription
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->firdbet->setSort("");
                $this->chilotname->setSort("");
                $this->kirihidet->setSort("");
                $this->yekisaynet->setSort("");
                $this->keteroreason->setSort("");
                $this->sex->setSort("");
                $this->tekesashbizat->setSort("");
                $this->keterodate->setSort("");
                $this->keterodescription->setSort("");
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"case_hears\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"case_hears\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"case_hears\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fcase_hearslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fcase_hearslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"case_hears\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fcase_hearslist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "tekesashbizat");
            $this->createColumnOption($option, "keterodate");
            $this->createColumnOption($option, "keterodescription");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fcase_hearssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcase_hearssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fcase_hearslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_case_hears", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_case_hears",
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fcase_hearslist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fcase_hearssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
