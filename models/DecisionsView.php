 ...
 * Page class
 */
class DecisionsView extends Decisions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DecisionsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DecisionsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DecisionsList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "DecisionsList"; // No matching record, return to list
                    } else {
