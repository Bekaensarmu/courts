...
class UsersList extends Users
{
    ...
    public function setVisibility()
    {
        ...
        $this->profile_photo_path->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->current_team_id->AdvancedSearch->toJson(), ","); // Field current_team_id
        $filterList = Concat($filterList, $this->profile_photo_path->AdvancedSearch->toJson(), ","); // Field profile_photo_path
    ...
    protected function restoreFilterList()
    {
        ...
        $this->current_team_id->AdvancedSearch->SearchValue = @$filter["x_current_team_id"];
        $this->current_team_id->AdvancedSearch->SearchOperator = @$filter["z_current_team_id"];
        $this->current_team_id->AdvancedSearch->SearchCondition = @$filter["v_current_team_id"];
        $this->current_team_id->AdvancedSearch->SearchValue2 = @$filter["y_current_team_id"];
        $this->current_team_id->AdvancedSearch->SearchOperator2 = @$filter["w_current_team_id"];
        $this->current_team_id->AdvancedSearch->save();

        // Field profile_photo_path
        $this->profile_photo_path->AdvancedSearch->SearchValue = @$filter["x_profile_photo_path"];
        $this->profile_photo_path->AdvancedSearch->SearchOperator = @$filter["z_profile_photo_path"];
        $this->profile_photo_path->AdvancedSearch->SearchCondition = @$filter["v_profile_photo_path"];
        $this->profile_photo_path->AdvancedSearch->SearchValue2 = @$filter["y_profile_photo_path"];
        $this->profile_photo_path->AdvancedSearch->SearchOperator2 = @$filter["w_profile_photo_path"];
        $this->profile_photo_path->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->profile_photo_path;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->current_team_id); // current_team_id
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->current_team_id->setSort("");
                $this->profile_photo_path->setSort("");
            ...
            foreach ($this->ListActions as $listAction) {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $profile = UserProfile::create()->setUserName(strval($this->_email->CurrentValue))
                        ->load(HtmlDecode($this->description->CurrentValue));
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "current_team_id");
