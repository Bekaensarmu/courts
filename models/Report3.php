 ...
 */
class Report3 extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->fileNumber->GroupingFieldId = 1;
        $this->fileNumber->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->fileNumber->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->fileNumber->GroupByType = "";
        $this->fileNumber->GroupInterval = "0";
        $this->fileNumber->GroupSql = "";
        ...
        $this->sex->Lookup = new Lookup($this->sex, 'Report3', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->fileNumber;
