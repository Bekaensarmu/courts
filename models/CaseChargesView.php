 ...
 * Page class
 */
class CaseChargesView extends CaseCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CaseChargesView";
    ...
    // CSS class/style
    public $CurrentPageName = "CaseChargesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CaseChargesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CaseChargesList"; // No matching record, return to list
                    } else {
