 ...
 * Page class
 */
class Report4Summary extends Report4
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Report4Summary";
    ...
    public $CurrentPageName = "Report4";
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["Report4"]) || $GLOBALS["Report4"]::class == PROJECT_NAMESPACE . "Report4") {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Report4');
        }
    ...
    public function loadGroupRowValues()
    {
        ...
        if ($this->GroupCount < $cnt) {
            $this->keterodate->setGroupValue(reset($this->GroupRecords[$this->GroupCount]));
        } else {
            $this->keterodate->setGroupValue("");
        }
    }
    ...
    public function loadRowValues($record)
    {
        ...
        $this->melequtir->setDbValue($record['melequtir']);
        ...
        $this->keterodate->setDbValue(GroupValue($this->keterodate, $record['keterodate']));
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) {
            ...
            $this->keterodate->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->keterodate->AdvancedSearch->SearchValue, $this->keterodate->formatPattern()), $this->keterodate->formatPattern()));
            $this->keterodate->PlaceHolder = RemoveHtml($this->keterodate->caption());
            $this->keterodate->setupEditAttributes();
            $this->keterodate->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->keterodate->AdvancedSearch->SearchValue2, $this->keterodate->formatPattern()), $this->keterodate->formatPattern()));
            $this->keterodate->PlaceHolder = RemoveHtml($this->keterodate->caption());
            ...
            if ($this->RowTotalType == RowSummary::GROUP) {
                $this->RowAttrs["data-group"] = $this->keterodate->groupValue(); // Set up group attribute
            }

            // keterodate
            $this->keterodate->GroupViewValue = $this->keterodate->groupValue();
            $this->keterodate->GroupViewValue = FormatDateTime($this->keterodate->GroupViewValue, $this->keterodate->formatPattern());
            $this->keterodate->CellCssClass = ($this->RowGroupLevel == 1 ? "ew-rpt-grp-summary-1" : "ew-rpt-grp-field-1");
            $this->keterodate->GroupViewValue = DisplayGroupValue($this->keterodate, $this->keterodate->GroupViewValue);
            ...
            $this->keterodate->GroupViewValue = $this->keterodate->groupValue();
            $this->keterodate->GroupViewValue = FormatDateTime($this->keterodate->GroupViewValue, $this->keterodate->formatPattern());
            $this->keterodate->CellCssClass = "ew-rpt-grp-field-1";
            $this->keterodate->GroupViewValue = DisplayGroupValue($this->keterodate, $this->keterodate->GroupViewValue);
            if (!$this->keterodate->LevelBreak) {
                $this->keterodate->GroupViewValue = "";
            } else {
                $this->keterodate->LevelBreak = false;
            }
            ...
            $this->keterodescription->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) {
            // keterodate
            $currentValue = $this->keterodate->GroupViewValue;
            $viewValue = &$this->keterodate->GroupViewValue;
            $viewAttrs = &$this->keterodate->ViewAttrs;
            $cellAttrs = &$this->keterodate->CellAttrs;
            $hrefValue = &$this->keterodate->HrefValue;
            $linkAttrs = &$this->keterodate->LinkAttrs;
            $this->cellRendered($this->keterodate, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        } else {
            // keterodate
            $currentValue = $this->keterodate->groupValue();
            $viewValue = &$this->keterodate->GroupViewValue;
            $viewAttrs = &$this->keterodate->ViewAttrs;
            $cellAttrs = &$this->keterodate->CellAttrs;
            $hrefValue = &$this->keterodate->HrefValue;
            ...
            // keterodescription
            $currentValue = $this->keterodescription->CurrentValue;
            $viewValue = &$this->keterodescription->ViewValue;
            $viewAttrs = &$this->keterodescription->ViewAttrs;
            $cellAttrs = &$this->keterodescription->CellAttrs;
            $hrefValue = &$this->keterodescription->HrefValue;
            $linkAttrs = &$this->keterodescription->LinkAttrs;
            $this->cellRendered($this->keterodescription, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->keterodate->Visible) {
            $this->GroupColumnCount += 1;
        }
        if ($this->keteroreason->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->keterodescription->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fReport4srch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    {
        return $this->keterodate->Visible;
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fReport4srch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fReport4srch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    protected function getExtendedFilter()
    {
        ...
        if (Get("cmd") == "reset") {
            // Set default values
            $this->keterodate->AdvancedSearch->unsetSession();
            $restoreDefault = true;
        } else {
            $restoreSession = !$this->SearchCommand;

            // Field keterodate
            if ($this->keterodate->AdvancedSearch->get()) {
            }
        ...
        if ($restoreSession) {
            $restoreDefault = true;
            if ($this->keterodate->AdvancedSearch->issetSession()) { // Field keterodate
                $this->keterodate->AdvancedSearch->load();
                $restoreDefault = false;
            }
        }
        ...
        $this->buildExtendedFilter($this->keterodate, $filter, false, true); // Field keterodate
    ...
    {
        // Field keterodate
        $this->keterodate->AdvancedSearch->loadDefault();
    }
    ...
    public function showFilterList()
    {
        ...
        // Field keterodate
        $extWrk = "";
        $this->buildExtendedFilter($this->keterodate, $extWrk);
        $filter = "";
        if ($extWrk != "") {
            $filter .= "<span class=\"ew-filter-value\">$extWrk</span>";
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->keterodate->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fReport4srch");
        }

        // Field keterodate
        $wrk = "";
        if ($this->keterodate->AdvancedSearch->SearchValue != "" || $this->keterodate->AdvancedSearch->SearchValue2 != "") {
            $wrk = "\"x_keterodate\":\"" . JsEncode($this->keterodate->AdvancedSearch->SearchValue) . "\"," .
                "\"z_keterodate\":\"" . JsEncode($this->keterodate->AdvancedSearch->SearchOperator) . "\"," .
                "\"v_keterodate\":\"" . JsEncode($this->keterodate->AdvancedSearch->SearchCondition) . "\"," .
                "\"y_keterodate\":\"" . JsEncode($this->keterodate->AdvancedSearch->SearchValue2) . "\"," .
                "\"w_keterodate\":\"" . JsEncode($this->keterodate->AdvancedSearch->SearchOperator2) . "\"";
        }
        if ($wrk != "") {
            if ($filterList != "") {
                $filterList .= ",";
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fReport4srch", $filters);
    ...
    protected function setupFilterList($filter)
    {
        ...
        // Field keterodate
        if (!$this->keterodate->AdvancedSearch->get($filter)) {
            $this->keterodate->AdvancedSearch->loadDefault(); // Clear filter
        }
        $this->keterodate->AdvancedSearch->save();
        return true;
    }
