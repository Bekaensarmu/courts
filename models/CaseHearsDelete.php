 ...
 * Page class
 */
class CaseHearsDelete extends CaseHears
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CaseHearsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CaseHearsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CaseHearsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("CaseHearsList"); // Return to list
                return;
            }
        }
