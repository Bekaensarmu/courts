 ...
 * Page class
 */
class AttorneysDelete extends Attorneys
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AttorneysDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AttorneysDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AttorneysList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AttorneysList"); // Return to list
                return;
            }
        }
