...
/**
 * Table class for wittnesses
 */
class Wittnesses extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // wittnessID
        $this->wittnessID = new DbField(
            $this, // Table
            'x_wittnessID', // Variable name
            'wittnessID', // Name
            '`wittnessID`', // Expression
            '`wittnessID`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`wittnessID`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->wittnessID->InputTextType = "text";
        $this->wittnessID->Nullable = false; // NOT NULL field
        $this->wittnessID->Required = true; // Required field
        $this->wittnessID->Sortable = false; // Allow sort
        $this->wittnessID->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['wittnessID'] = &$this->wittnessID;
        ...
        // wittnessType
        $this->wittnessType = new DbField(
            $this, // Table
            'x_wittnessType', // Variable name
            'wittnessType', // Name
            '`wittnessType`', // Expression
            '`wittnessType`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`wittnessType`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->wittnessType->InputTextType = "text";
        $this->wittnessType->Nullable = false; // NOT NULL field
        $this->wittnessType->Required = true; // Required field
        $this->wittnessType->Lookup = new Lookup($this->wittnessType, 'wittnesses', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->wittnessType->OptionCount = 2;
        $this->wittnessType->SearchOperators = ["=", "<>"];
        $this->Fields['wittnessType'] = &$this->wittnessType;
        ...
        $this->updated_by->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "wittnesses";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->wittnessID->DbValue = $row['wittnessID'];
        $this->name->DbValue = $row['name'];
        $this->address->DbValue = $row['address'];
        $this->state->DbValue = $row['state'];
        $this->wittnessType->DbValue = $row['wittnessType'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("WittnessesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "WittnessesView" => $Language->phrase("View"),
            "WittnessesEdit" => $Language->phrase("Edit"),
            "WittnessesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "WittnessesView",
            Config("API_ADD_ACTION") => "WittnessesAdd",
            Config("API_EDIT_ACTION") => "WittnessesEdit",
            Config("API_DELETE_ACTION") => "WittnessesDelete",
            Config("API_LIST_ACTION") => "WittnessesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("WittnessesView", $parm);
        } else {
            $url = $this->keyUrl("WittnessesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("WittnessesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("WittnessesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("WittnessesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("WittnessesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("WittnessesDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->wittnessID->EditValue = $this->wittnessID->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->wittnessType);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->wittnessType);
