 ...
 * Page class
 */
class JudgesEdit extends Judges
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "JudgesEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("JudgesList"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // judgeID
        $this->judgeID->setDbValueDef($rsnew, $this->judgeID->CurrentValue, $this->judgeID->ReadOnly);

        // name
        $this->name->setDbValueDef($rsnew, $this->name->CurrentValue, $this->name->ReadOnly);

        // courtTyep
        $this->courtTyep->setDbValueDef($rsnew, $this->courtTyep->CurrentValue, $this->courtTyep->ReadOnly);
