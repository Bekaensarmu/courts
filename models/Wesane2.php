...
/**
 * Table class for wesane2
 */
class Wesane2 extends CrosstabTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'wesane'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->address->SourceTableVar = 'wesane';
        ...
        $this->state->Lookup = new Lookup($this->state, 'case_charges', false, 'deptName', ["rank","","",""], '', '', [], [], [], [], [], [], false, '', '', "`rank`");
        ...
        $this->state->SourceTableVar = 'wesane';
        ...
        $this->status->SourceTableVar = 'wesane';
        ...
        $this->deptname->SourceTableVar = 'wesane';
        ...
        $this->updated_at->GroupingFieldId = 1;
        ...
        $this->updated_at->SourceTableVar = 'wesane';
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->updated_at;
    ...
    {
        return ($this->columnField != "") ? $this->columnField : "`status`";
    }
    ...
    {
        return $this->sqlDistinctSelect ?? $this->getQueryBuilder()->select("`status`")->distinct();
    }
    ...
    {
        return ($this->sqlDistinctOrderBy != "") ? $this->sqlDistinctOrderBy : "`status` ASC";
    }
...
*/
        ...
        $groupCount = 1;
        $this->SummaryFields[0] = new SummaryField('x_address', 'address', '`address`', 'COUNT');
    ...
    {
        return $this->SqlGroupBy != "" ? $this->SqlGroupBy : "`updated_at`";
    }
