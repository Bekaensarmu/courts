 ...
 * Page class
 */
class AppealDelete extends Appeal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AppealDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AppealDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AppealList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AppealList"); // Return to list
                return;
            }
        }
