...
<?= $Page->Pager->render() ?>
<?php } ?>
<form name="fspecialfilesedit" id="fspecialfilesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { specialfiles: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fspecialfilesedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        ...
        .setFields([
            ...
            ["_12E81270123B123B12081260127512401295", [fields._12E81270123B123B12081260127512401295.visible && fields._12E81270123B123B12081260127512401295.required ? ew.Validators.required(fields._12E81270123B123B12081260127512401295.caption) : null], fields._12E81270123B123B12081260127512401295.isInvalid],
            ["_121812DD130B1262", [fields._121812DD130B1262.visible && fields._121812DD130B1262.required ? ew.Validators.required(fields._121812DD130B1262.caption) : null], fields._121812DD130B1262.isInvalid],
...
<script>
loadjs.ready(["fspecialfilesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fspecialfilesedit", "x__12E81270121812D8130812601260127512401295", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->sid->Visible) { // sid ?>
    <div id="r_sid"<?= $Page->sid->rowAttributes() ?>>
        <label id="elh_specialfiles_sid" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sid->caption() ?><?= $Page->sid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->sid->cellAttributes() ?>>
<span id="el_specialfiles_sid">
...
<input type="hidden" data-table="specialfiles" data-field="x_sid" data-hidden="1" name="x_sid" id="x_sid" value="<?= HtmlEncode($Page->sid->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fspecialfilesedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fspecialfilesedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
