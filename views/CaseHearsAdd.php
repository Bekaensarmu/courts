...
$Page->showMessage();
?>
<form name="fcase_hearsadd" id="fcase_hearsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<span id="el_case_hears_RANKe">
    <select
        ...
        data-select2-id="fcase_hearsadd_x_RANKe"
        <?php } ?>
...
<?php if (!$Page->RANKe->IsNativeSelect) { ?>
<script>
loadjs.ready("fcase_hearsadd", function() {
    var options = { name: "x_RANKe", selectId: "fcase_hearsadd_x_RANKe" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcase_hearsadd.lists.RANKe?.lookupOptions.length) {
        options.data = { id: "x_RANKe", form: "fcase_hearsadd" };
    } else {
        options.ajax = { id: "x_RANKe", form: "fcase_hearsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_case_hears_ez">
    <select
        ...
        data-select2-id="fcase_hearsadd_x_ez"
        <?php } ?>
        data-table="case_hears"
        data-field="x_ez"
...
<script>
loadjs.ready("fcase_hearsadd", function() {
    var options = { name: "x_ez", selectId: "fcase_hearsadd_x_ez" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcase_hearsadd.lists.ez?.lookupOptions.length) {
        options.data = { id: "x_ez", form: "fcase_hearsadd" };
    } else {
        options.ajax = { id: "x_ez", form: "fcase_hearsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_case_hears_firdbet">
    <select
        ...
        data-select2-id="fcase_hearsadd_x_firdbet"
        <?php } ?>
        data-table="case_hears"
...
<script>
loadjs.ready("fcase_hearsadd", function() {
    var options = { name: "x_firdbet", selectId: "fcase_hearsadd_x_firdbet" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcase_hearsadd.lists.firdbet?.lookupOptions.length) {
        options.data = { id: "x_firdbet", form: "fcase_hearsadd" };
    } else {
        options.ajax = { id: "x_firdbet", form: "fcase_hearsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_case_hears_chilotname">
    <select
        ...
        data-select2-id="fcase_hearsadd_x_chilotname"
        <?php } ?>
        data-table="case_hears"
...
<script>
loadjs.ready("fcase_hearsadd", function() {
    var options = { name: "x_chilotname", selectId: "fcase_hearsadd_x_chilotname" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcase_hearsadd.lists.chilotname?.lookupOptions.length) {
        options.data = { id: "x_chilotname", form: "fcase_hearsadd" };
    } else {
        options.ajax = { id: "x_chilotname", form: "fcase_hearsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_case_hears_kirihidet">
    <select
        ...
        data-select2-id="fcase_hearsadd_x_kirihidet"
        <?php } ?>
        data-table="case_hears"
...
<script>
loadjs.ready("fcase_hearsadd", function() {
    var options = { name: "x_kirihidet", selectId: "fcase_hearsadd_x_kirihidet" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcase_hearsadd.lists.kirihidet?.lookupOptions.length) {
        options.data = { id: "x_kirihidet", form: "fcase_hearsadd" };
    } else {
        options.ajax = { id: "x_kirihidet", form: "fcase_hearsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_case_hears_yekisaynet">
    <select
        ...
        data-select2-id="fcase_hearsadd_x_yekisaynet"
        <?php } ?>
        data-table="case_hears"
...
<script>
loadjs.ready("fcase_hearsadd", function() {
    var options = { name: "x_yekisaynet", selectId: "fcase_hearsadd_x_yekisaynet" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcase_hearsadd.lists.yekisaynet?.lookupOptions.length) {
        options.data = { id: "x_yekisaynet", form: "fcase_hearsadd" };
    } else {
        options.ajax = { id: "x_yekisaynet", form: "fcase_hearsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_case_hears_keteroreason">
    <select
        ...
        data-select2-id="fcase_hearsadd_x_keteroreason"
        <?php } ?>
        data-table="case_hears"
...
<script>
loadjs.ready("fcase_hearsadd", function() {
    var options = { name: "x_keteroreason", selectId: "fcase_hearsadd_x_keteroreason" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcase_hearsadd.lists.keteroreason?.lookupOptions.length) {
        options.data = { id: "x_keteroreason", form: "fcase_hearsadd" };
    } else {
        options.ajax = { id: "x_keteroreason", form: "fcase_hearsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<script>
loadjs.ready(["fcase_hearsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcase_hearsadd", "x_keterodate", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcase_hearsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcase_hearsadd", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcase_hearsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fcase_hearsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
