...
<?php if ($Page->description->Visible) { // description ?>
    <tr id="r_description"<?= $Page->description->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_users_description"><?= $Page->description->caption() ?></span></td>
...
<?php if ($Page->current_team_id->Visible) { // current_team_id ?>
    <tr id="r_current_team_id"<?= $Page->current_team_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_users_current_team_id"><?= $Page->current_team_id->caption() ?></span></td>
...
<?php if ($Page->profile_photo_path->Visible) { // profile_photo_path ?>
    <tr id="r_profile_photo_path"<?= $Page->profile_photo_path->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_users_profile_photo_path"><?= $Page->profile_photo_path->caption() ?></span></td>
        <td data-name="profile_photo_path"<?= $Page->profile_photo_path->cellAttributes() ?>>
<span id="el_users_profile_photo_path">
<span>
<?= GetImageViewTag($Page->profile_photo_path, $Page->profile_photo_path->getViewValue()) ?></span>
</span>
</td>
    </tr>
<?php } ?>
