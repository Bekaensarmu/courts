...
<?php if ($Page->current_team_id->Visible) { // current_team_id ?>
        <th data-name="current_team_id" class="<?= $Page->current_team_id->headerCellClass() ?>"><div id="elh_users_current_team_id" class="users_current_team_id"><?= $Page->renderFieldHeader($Page->current_team_id) ?></div></th>
<?php } ?>
...
<?= $Page->_password->getViewValue() ?></span>
    ...
    <?php } ?>
    <?php if ($Page->current_team_id->Visible) { // current_team_id ?>
        <td data-name="current_team_id"<?= $Page->current_team_id->cellAttributes() ?>>
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_users_current_team_id" class="el_users_current_team_id">
<span<?= $Page->current_team_id->viewAttributes() ?>>
<?= $Page->current_team_id->getViewValue() ?></span>
</span>
</td>
    <?php } ?>
    <?php if ($Page->created_at->Visible) { // created_at ?>
