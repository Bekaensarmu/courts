...
<?php if ($Page->current_team_id->Visible) { // current_team_id ?>
        <th class="<?= $Page->current_team_id->headerCellClass() ?>"><span id="elh_users_current_team_id" class="users_current_team_id"><?= $Page->current_team_id->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->current_team_id->Visible) { // current_team_id ?>
        <td<?= $Page->current_team_id->cellAttributes() ?>>
<span id="">
