...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "LYt8pX350ZBLHCz79C96W6uop1jnLdRWQUNMZ0y9iAg=", // AES encryption key (base64 encoded)
    ...
    // Export Log
    "EXPORT_PATH" => "export-5c70c1a0-7bd3-4bbb-9481-d6dd6daf2cdc", // Export folder
    ...
    "PARENT_USER_ID_FIELD_NAME" => "email",
    "USER_LEVEL_FIELD_NAME" => "current_team_id",
    "USER_PROFILE_FIELD_NAME" => "description",
    ...
    // Email
    "SENDER_EMAIL" => "admin@admin.com", // Sender email address
    "RECIPIENT_EMAIL" => "admin@admin", // Recipient email address
    ...
    "IMPORT_FILE_ALLOWED_EXTENSIONS" => "csv,xlsx", // Import file allowed extensions
