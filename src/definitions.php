...
return [
    ...
    "attorneys" => \DI\create(Attorneys::class),
    "bars" => \DI\create(Bars::class),
    "case_charges" => \DI\create(CaseCharges::class),
    "case_hears" => \DI\create(CaseHears::class),
    "courts" => \DI\create(Courts::class),
    "decisions" => \DI\create(Decisions::class),
    "judges" => \DI\create(Judges::class),
    "userlevels" => \DI\create(Userlevels::class),
    "users" => \DI\create(Users::class),
    "wittnesses" => \DI\create(Wittnesses::class),
    "appeal" => \DI\create(Appeal::class),
    "specialfiles" => \DI\create(Specialfiles::class),
    "Report2" => \DI\create(Report2::class),
    "Report3" => \DI\create(Report3::class),
    "Report4" => \DI\create(Report4::class),
    "Report5" => \DI\create(Report5::class),
    "Report6" => \DI\create(Report6::class),
    "Crosstab1" => \DI\create(Crosstab1::class),
    "Dashboard1" => \DI\create(Dashboard1::class),
    "Crosstab2" => \DI\create(Crosstab2::class),
    "Crosstab3" => \DI\create(Crosstab3::class),
